/**
 * Idempotent dev seed: one coach (on a 7-day trial) with a small exercise
 * library, one *unlinked* student profile (keyed by phone — to be claimed when
 * that phone registers), and a 2-day program containing a superset.
 *
 * Demo identifiers:
