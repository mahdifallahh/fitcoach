    ...
    <div className="mx-auto max-w-2xl space-y-5">
      ...
      {day && (
        <div className="space-y-4">
          {day.title && <h2 className="text-lg font-semibold text-primary">{day.title}</h2>}
          ...
          {rows.length === 0 ? (
            ...
            rows.map((row, i) =>
              row.type === 'superset' ? (
                <div key={i} className="space-y-3 rounded-2xl border-2 border-primary/30 bg-primary/5 p-3">
    ...
    <div className="overflow-hidden rounded-2xl border bg-card">
      ...
      <div className="space-y-2 p-4">
        <div className="flex items-start justify-between gap-3">
          <h3 className="text-lg font-bold leading-tight">{ex.exercise.name}</h3>
