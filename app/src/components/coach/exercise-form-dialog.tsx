...
import { useCreateExercise, useUpdateExercise } from '@/lib/query/use-exercises';
      ...
      <DialogContent>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Input id="ex-name" placeholder={t('namePlaceholder')} {...register('name')} />
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-2">
              ...
              <Input id="ex-sets" type="number" min={1} max={50} {...register('defaultSets', { valueAsNumber: true })} />
            </div>
            <div className="space-y-2">
              <Label htmlFor="ex-reps">{t('reps')}</Label>
              <Input id="ex-reps" dir="ltr" placeholder={t('repsPlaceholder')} {...register('defaultReps')} />
            </div>
          </div>
