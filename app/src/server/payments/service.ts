import 'server-only';
import { PaymentGateway, PaymentStatus, Prisma, SubscriptionPlan, type PrismaClient } from '@prisma/client';
...
export class PaymentsService {
  ...
  private async markPaidAndActivate(
    ...
    console.log(`[payments] ${payment.id} paid → subscription ${sub.id} active until ${sub.endsAt.toISOString()}`);
  }
